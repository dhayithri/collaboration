...
public class UsersServiceImpl implements UsersService{
	...
	/*Creating new user*/
	public void UserRegistration(User users) 
	{
		users.setEnabled("1");       		/*User is enabled when he registers*/
		users.setRole("ROLE_USER");     /*Default role after registration is User*/
		usersDAO.saveOrUpdate(users);   		/*Registering new user*/
	}
